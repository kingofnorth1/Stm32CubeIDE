...
void LCD_ShowPicture(const uint8_t *address, uint16_t startX, uint16_t startY);//显示图片
void LCD_display_char16_16(const uint8_t* address, uint16_t startx,uint16_t starty,uint16_t color);
